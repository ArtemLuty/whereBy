...
class ColorConstants {
  // Common
  static const Color primaryBlue = Color(0xFF3949F5);
  static const Color appWhite = Color(0xffffffff);
  static const Color buttonColor = Color(0xFF3949F5);
  static const Color buttonDeclineColor = Color(0xFFE1E1E6);
  static const Color forgotPassword = Color(0xFFA7AEFF);
  ...
  static const Color mainGray = Color(0xFF575761);
  static const Color containerColor = Color(0xFFF6F6F9);
  static const Color dividerColor = Color(0xFFBABABE);

  // // tapBar

  static const Color tapColor = Color(0xFF4AD3B0);
  static const Color tapTextColor = Color(0xFF181D63);
  static const Color tapAditionColor = Color(0xFFC2F0E4);
}
